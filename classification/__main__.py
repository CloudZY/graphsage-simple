...
def main(args):
    ...
    if args.label_file and args.method != 'gcn':
        ...
        # print(clf.split_train_evaluate_graphsage(X, Y, args.clf_ratio, ids))



        # clf.split_train_evaluate_based_on_group(X, Y, args.clf_ratio)
        # for i in range(1, 20):
        #     clf.split_train_evaluate_based_on_degree(X, Y, args.clf_ratio, i)
    ...
    #     # Sorted X, Y
        ...
        group_size = 10
        clf = Classifier(vectors=vectors, clf=LogisticRegression())
        clf.split_train_evaluate_based_on_group(X_sorted, Y_sorted, args.clf_ratio, group_size, "group_based_train_" + str(group_size) + "gs_degree_rand.txt")
        # clf.split_train_evaluate_based_on_degree(X_sorted, Y_sorted, args.clf_ratio)
        ...
        #         args.clf_ratio*100))
        #     clf = Classifier(vectors=vectors, clf=LogisticRegression())
        #     clf.split_train_evaluate_original(X, Y, args.clf_ratio)
